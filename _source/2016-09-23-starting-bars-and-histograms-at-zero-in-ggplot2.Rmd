...
```{r cowplot_summary, message=FALSE, fig.width = 12, fig.height=4.5, echo=FALSE, fig.cap="Summary plot. Default plot, without expand plot and without expand and limits plot"}
# libraries
library(cowplot)
