...
(*hadleyverse*, *shiny*, *htmlwidgets*...) even in those frustating moments that
everyone knows, struggling with the code to achieve some data analysis or
...
with its *pros* and *cons*, a subjective ones by the way.
  ...
  + **Pros**
    ...
    1. It uses `rmarkdown v2`, which is nice because it allows you all the
       interactive stuff (interactive documents, shiny...)
...
So, after a google search, I found
[this](https://brendanrocks.com/blogging-with-rmarkdown-knitr-jekyll/) which
led me to
[this repository](https://github.com/yihui/knitr-jekyll). In this repository,
